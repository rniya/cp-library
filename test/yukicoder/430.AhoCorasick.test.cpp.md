...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/430.AhoCorasick.test.cpp\"\n#define PROBLEM\
    ...
    \ typename V> ostream& operator<<(ostream& os, const tuple<T, U, V>& t) {\n  \
    \  os << '(' << get<0>(t) << ',' << get<1>(t) << ',' << get<2>(t) << ')';\n  \
    \  return os;\n}\ntemplate <typename T, typename U, typename V, typename W> ostream&\
    \ operator<<(ostream& os, const tuple<T, U, V, W>& t) {\n    os << '(' << get<0>(t)\
