...
data:
  ...
  bundledCode: "#line 2 \"geometry/geometry.hpp\"\n#include <algorithm>\n#include\
    ...
    \ { return x < -EPS ? -1 : x > EPS ? 1 : 0; }\n\ninline int compare(Real a, Real\
    \ b) { return sgn(a - b); }\n\ninline bool equals(Real a, Real b) { return compare(a,\
    \ b) == 0; }\n\nstruct Point {\n    Real x, y;\n\n    Point() {}\n\n    Point(Real\
    ...
    \ operator==(const Point& p) const { return (compare(x, p.x) == 0 && compare(y,\
  ...
  code: "#pragma once\n#include <algorithm>\n#include <cassert>\n#include <cmath>\n\
    ...
    \ Real& r, const Real& theta) { return Point(cos(theta), sin(theta)) * r; }\n\n\
