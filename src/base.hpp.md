...
data:
  ...
  code: "#pragma once\n#include <bits/stdc++.h>\nusing namespace std;\ntypedef long\
    ...
    \ ? \"\" : \" \");\n    }\n    return os;\n}\n\ntemplate <typename T> T gcd(T\
    \ x, T y) { return y != 0 ? gcd(y, x % y) : x; }\ntemplate <typename T> T lcm(T\
    \ x, T y) { return x / gcd(x, y) * y; }\n\nint topbit(signed t) { return t ==\
    \ 0 ? -1 : 31 - __builtin_clz(t); }\nint topbit(long long t) { return t == 0 ?\
    \ -1 : 63 - __builtin_clzll(t); }\nint botbit(signed a) { return a == 0 ? 32 :\
